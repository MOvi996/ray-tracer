...
void a_textures() {
    ...
    engine.render(img);
    img.writeEXR("../images/textures-procedural.exr");

    world.scene = imageTexturesBorder();
    engine.render(img);
    img.writeEXR("../images/textures-border.exr");

    world.scene = imageTexturesInterpolate();
    engine.render(img);
    img.writeEXR("../images/textures-interpolate.exr");

    world.scene = imageDebugTextures(ImageTexture::CLAMP);
    engine.render(img);
    img.writeEXR("../images/textures-clamp.exr");

    world.scene = imageDebugTextures(ImageTexture::REPEAT);
    engine.render(img);
    img.writeEXR("../images/textures-repeat.exr");

    world.scene = imageDebugTextures(ImageTexture::MIRROR);
    engine.render(img);
    img.writeEXR("../images/textures-mirror.exr");
}
