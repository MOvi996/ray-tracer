...
void a_lighting() {
    renderCornellboxA(0.0001f, "../images/lighting-1.exr");
    renderCornellboxA(0.001f, "../images/lighting-2.exr");
    renderCornellboxB(0.0001f, "../images/lighting-3.exr");
    renderCornellboxB(0.001f, "../images/lighting-4.exr");
}