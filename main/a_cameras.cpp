...
void a_cameras() {
    ...
    r1.test_render2(img);
    r1.test_render2(low);
    img.writeEXR("../images/a1-2.exr");
    low.writeEXR("../images/a1-2-low.exr");
    img.writePNG("../images/a1-2.PNG");
    low.writeEXR("../images/a1-2-low.PNG");
    ...
    img.writeEXR("../images/a1-3.exr");
    img.writePNG("../images/a1-3.PNG");
    */

    OrthographicCamera ocam(Point(0, 0, 0), Vector(0.1f, 0.1f, 1), Vector(0.2f, 1.0f, 0.2f), 10.f, 10.f);
    Renderer r2(&ocam,0);
    r2.test_render2(img);
    img.writeEXR("../images/a1-4.exr");
    img.writePNG("../images/a1-4.PNG");


    // FisheyeCamera fcam(Point(0, 0, 0), Vector(1, 0, 0.1f), Vector(0, 0, 1), 0.9*pi);
    // Renderer r3(&fcam,0);
    // r3.test_render2(img);
    // img.writeEXR("../images/a1-6.exr");
    // img.writePNG("../images/a1-6.PNG");


    // //EnvironmentCamera ecam(Point(0, 0, 0), Vector(1, 0, 0.1f), Vector(0, 0, 1), 0.9*pi, 0.9*pi);
    // Renderer r4(&ecam,0);
    // r4.test_render2(img);
    // img.writeEXR("../images/a1-7.exr");
    // img.writePNG("../images/a1-7.PNG");
