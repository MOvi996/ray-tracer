...
void a_mappers() {
    //trynomapper("../images/mapper-none.exr");
    trymapper("../images/mapper-nullptr.exr", nullptr, nullptr);
    trymapper("../images/mapper-plane.exr",
    ...
    trymapper("../images/mapper-cylindrical.exr",
    ...
    trymapper("../images/mapper-spherical.exr",
