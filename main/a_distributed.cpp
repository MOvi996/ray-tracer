...
void a_distributed() {
    ...
    //renderCornellbox(0.001f, "../images/distributed-a.exr", cam, sphereMaterial1, floorMaterial1, 30);
    //renderCornellbox(0.001f, "../images/distributed-b.exr", cam, sphereMaterial2, floorMaterial2, 30);
    //renderCornellbox(0.001f, "../images/distributed-c.exr", dofcam, sphereMaterial2, floorMaterial2, 30);
    renderCornellbox(0.001f, "../images/distributed-d.exr", dofcam, sphereMaterial2, floorMaterial2, 1000);
}